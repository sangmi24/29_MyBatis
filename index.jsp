...
<body>
  ...
  <!-- 
     * 프레임워크
     ...
     - 소프트웨어 개발의 입장으로써는 공통으로 사용하는 라이브러리 / 개발도구 / 인터페이스 등등을 포괄적으로 의미
     
     * 왜 프레임워크를 쓰는가 ? 필요성
     - 현재 웹프로그래밍 규모가 커지고 있음 
     => 거대하고 복잡도가 높은 프로젝트를 완성시키기 위해서는 많은 개발자들이 필요함
     => 그 개발자들이 "통일성" 있게 "빠르고" "안정적으로" 웹사이트를 개발하기 위한 걸로
     ...
     * 프레임워크의 종류
     ...
     - 자바 : 웹 애플리케이션에 초점에 맞춰서 필요한 요소들을 모듈화해서 제공해주는 프레임워크
              ex) Spring, Struts, ..
     -화면 구현 : Front-end 를 보다 쉽게 구현 할 수 있게 틀을 제공해주는 프레임워크
              ex) Bootstrap, ..
   ...
   <!--  
      ...
      => .index.jsp 를 띄워주되 (localhost:8888/mybatis)
            화면은 main.jsp를 보여줄 수 있도록 "포워딩"으로 지정해줄 예정 
   -->
